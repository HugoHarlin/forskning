...
% the rest is bound in particulate matter in the sediment.
    ...
    pp.alpha = alpha_vec(p);  % Exponent governing the slope of the lake bottom
    ...
    for diff_max_x = [1,10,100,1000]
        for diff_max_z = [1,10,100,1000]
            ...
            file_name = "2D_benthic_results_V4_dx_" + num2str(diff_max_x) + "_dz_" + num2str(diff_max_z) + "_Xn_" + num2str(pp.Xn) + "_Zn_" + num2str(pp.Zn) + "_alpha_" + alpha_str(p);
