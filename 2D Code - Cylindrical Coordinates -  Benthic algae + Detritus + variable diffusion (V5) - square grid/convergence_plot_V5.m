...
res_vec  = (10:2:28); % stratified, kbg = 0.2
...
for i = 1:num_res % interating over the resolutions
    ...
    eval("p_" + num2str(res_vec(i)) + "= load(""2D_benthic_results_V5_alpha_1_kbg_0_2_res_" +num2str(res_vec(i)) +"   _Stratified_therm_depth_2_CONV_SIM"");"); % stratified simulations
